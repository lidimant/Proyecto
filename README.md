...
Una aplicación desarrollada con **FastAPI** que obtiene datos de restaurantes mediante la API de **Google Places** y los muestra desde un frontend web interactivo.
